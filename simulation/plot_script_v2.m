...
% hold on
% xlabel('Time (s)','fontsize',font_size,'Interpreter','latex');
% ylabel('INS Yaw Error ($\psi^{IN}_{err}, rad$)','fontsize',font_size,'Interpreter','latex');
% set(gca,'XMinorGrid','off','GridLineStyle','-','FontSize',line_size)
% grid on
% axis square
% 
...
% hold on
% xlabel('Time (s)','fontsize',font_size,'Interpreter','latex');
% ylabel('INS Pitch Error ($\theta^{IN}_{err}, rad$)','fontsize',font_size,'Interpreter','latex');
% set(gca,'XMinorGrid','off','GridLineStyle','-','FontSize',line_size)
% grid on
% axis square
% 
...
% hold on
% xlabel('Time (s)','fontsize',font_size,'Interpreter','latex');
% ylabel('INS Roll Error ($\phi^{IN}_{err}, rad$)','fontsize',font_size,'Interpreter','latex');
% set(gca,'XMinorGrid','off','GridLineStyle','-','FontSize',line_size)
% grid on
% axis square
% 
